...
Types: `feat`, `fix`, `docs`, `refactor`, `test`, `chore`, `security`. Scopes: crate names + `ui`, `tui`, `cli`, `specs`, `ci`. Single author: `forkwright <cody.kickertz@pm.me>`. No `Co-authored-by` lines. No agent attribution.
