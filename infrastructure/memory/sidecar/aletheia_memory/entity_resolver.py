...
STOPWORDS = {
    ...
    "in", "on", "at", "to", "for", "of", "by", "with", "from", "up",
    "about", "into", "over", "after", "before", "between", "through",
    # Common verbs that appear capitalized at sentence starts
    "uses", "used", "using", "works", "working", "worked",
    "runs", "running", "ran", "makes", "making", "made",
    "gets", "getting", "got", "sets", "setting", "set",
    "takes", "taking", "took", "gives", "giving", "gave",
    "keeps", "keeping", "kept", "lets", "letting", "let",
    "says", "saying", "said", "goes", "going", "went", "gone",
    "comes", "coming", "came", "puts", "putting", "put",
    "wants", "wanted", "needs", "needed", "knows", "known",
    "shows", "showing", "shown", "finds", "finding", "found",
    "tells", "telling", "told", "asks", "asking", "asked",
    "calls", "calling", "called", "tries", "trying", "tried",
    "starts", "starting", "started", "stops", "stopping", "stopped",
    "moves", "moving", "moved", "reads", "reading", "read",
    "writes", "writing", "written", "sends", "sending", "sent",
    "builds", "building", "built", "creates", "creating", "created",
    "adds", "adding", "added", "checks", "checking", "checked",
    "looks", "looking", "looked", "opens", "opening", "opened",
    "closes", "closing", "closed", "helps", "helping", "helped",
    "means", "meaning", "meant", "seems", "seeming", "seemed",
    "provides", "provided", "includes", "included", "including",
    "requires", "required", "returns", "returned",
    "supports", "supported", "allows", "allowed",
    "enables", "enabled", "handles", "handled",
    "expects", "expected", "contains", "contained",
    "follows", "following", "followed",
    "applies", "applied", "matches", "matched",
    "passes", "passed", "fails", "failed",
    "exists", "existed", "defines", "defined",
    "loads", "loaded", "stores", "stored",
    "parses", "parsed", "updates", "updated",
    "manages", "managed", "tracks", "tracked",
    "generates", "generated", "processes", "processed",
    "triggers", "triggered", "resolves", "resolved",
    "detects", "detected", "filters", "filtered",
    "removes", "removed", "deletes", "deleted",
    "ensures", "merges", "merged", "fixes", "fixed",
    # Common adjectives/adverbs that get capitalized
    "new", "old", "good", "bad", "high", "low", "long", "short",
    "first", "last", "next", "full", "empty", "clean", "clear",
    "single", "multiple", "various", "current", "recent",
    "available", "active", "all", "each", "every", "some", "any",
    "same", "other", "both", "many", "few", "most", "more", "less",
    "real", "actual", "total", "main", "major", "minor",
    "specific", "general", "common", "standard", "basic",
    "important", "critical", "key", "primary", "secondary",
    "different", "similar", "related", "existing", "remaining",
    "correct", "wrong", "better", "best", "worst",
    "possible", "likely", "probably", "actually", "basically",
    "non", "pre", "post", "sub", "re",
    ...
    "example", "instance", "version", "format", "pattern",
    "reason", "context", "scope", "range", "threshold",
    "impact", "effort", "cost", "benefit", "risk",
    "summary", "overview", "detail", "description",
    "implementation", "medium",
    # Sentence-start words that aren't entities
    "here", "there", "now", "today", "currently", "previously",
    "however", "therefore", "instead", "otherwise", "especially",
    "essentially", "typically", "generally", "specifically",
    "apparently", "obviously", "definitely", "exactly",
    "prefers", "interested", "familiar", "aware",
    "verified", "confirmed", "identified", "noticed",
    "suggested", "recommended", "decided", "agreed",
    "completed", "finished", "deployed", "installed",
    "configured", "tested", "documented", "archived",
    ...
    "normal", "special", "extra", "additional", "optional",
    "separate", "combined", "mixed", "pure", "shared",
    "temporary", "permanent", "final", "initial",
    "necessary", "sufficient", "minimal", "maximum", "minimum",
    "visible", "hidden", "public", "private", "protected",
    "above", "below", "inside", "outside",
    "original", "modified", "alternative", "equivalent",
}
