...
- **USER.md:** Symlinked to all agents. Does Akron need Alice's full reading list? Probably not. Consider agent-specific USER.md excerpts — each agent gets the sections relevant to their domain.
